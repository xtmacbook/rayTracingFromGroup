...
void buildThinLensTest(World* pWorld) {
	...
	pWorld->vp.set_hres(900);
	pWorld->vp.set_vres(900);
	pWorld->vp.set_pixel_size(0.2);
	...
	pWorld->background_color = black;			// default color - this can be left out
    ...
    pWorld->add_object(new Box(Point3D(-10, 0, 10), Point3D(5, 5, 5), new Matte));
	...
	pWorld->add_object(sphere_ptr10);
	...
	pWorld->add_object(sphere_ptr11);
	...
	pWorld->add_object(sphere_ptr12);
	...
	pWorld->add_object(sphere_ptr13);											// dark yellow (hidden)
	...
	pWorld->add_object(sphere_ptr14);
	...
	pWorld->add_object(sphere_ptr15);
	...
	pWorld->add_object(sphere_ptr16);
	...
	pWorld->add_object(sphere_ptr17);
	...
	pWorld->add_object(sphere_ptr18);
	...
	pWorld->add_object(sphere_ptr19);
	...
	pWorld->add_object(sphere_ptr20);
	...
	pWorld->add_object(sphere_ptr21);
	...
	pWorld->add_object(sphere_ptr22);
	...
	pWorld->add_object(sphere_ptr23);	
	...
	pWorld->add_object(sphere_ptr24);
	...
	pWorld->add_object(sphere_ptr25);
	...
	pWorld->add_object(sphere_ptr26);
	...
	pWorld->add_object(sphere_ptr27);
	...
	pWorld->add_object(sphere_ptr28);
	...
	pWorld->add_object(sphere_ptr29);
	...
	pWorld->add_object(sphere_ptr30);
	...
	pWorld->add_object(sphere_ptr31);
	...
	pWorld->add_object(sphere_ptr32);
	...
	pWorld->add_object(sphere_ptr33);
	...
	pWorld->add_object(sphere_ptr34);
	...
	pWorld->add_object(sphere_ptr35);
