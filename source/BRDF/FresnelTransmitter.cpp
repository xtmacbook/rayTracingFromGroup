#include "FresnelTransmitter.hpp"
...
FresnelTransmitter* FresnelTransmitter::clone(void)
{
...
void FresnelTransmitter::set_eta_in(const float ei) {
	eta_in = ei;
}

void FresnelTransmitter::set_eta_out(const float eo) {
	eta_out = eo;
}
