...
Instance::compute_bounding_box(void) {
	...
	v[0].x = object_bbox.p0.x; v[0].y = object_bbox.p0.y; v[0].z = object_bbox.p0.z;
	v[1].x = object_bbox.p1.x; v[1].y = object_bbox.p0.y; v[1].z = object_bbox.p0.z;
	v[2].x = object_bbox.p1.x; v[2].y = object_bbox.p1.y; v[2].z = object_bbox.p0.z;
	v[3].x = object_bbox.p0.x; v[3].y = object_bbox.p1.y; v[3].z = object_bbox.p0.z;

	v[4].x = object_bbox.p0.x; v[4].y = object_bbox.p0.y; v[4].z = object_bbox.p1.z;
	v[5].x = object_bbox.p1.x; v[5].y = object_bbox.p0.y; v[5].z = object_bbox.p1.z;
	v[6].x = object_bbox.p1.x; v[6].y = object_bbox.p1.y; v[6].z = object_bbox.p1.z;
	v[7].x = object_bbox.p0.x; v[7].y = object_bbox.p1.y; v[7].z = object_bbox.p1.z;
...
bool
Instance::shadow_hit(const Ray& ray, float& t) const {
	Ray inv_ray(ray);
	inv_ray.o = inv_matrix * inv_ray.o;
	inv_ray.d = inv_matrix * inv_ray.d;
