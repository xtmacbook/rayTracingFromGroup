...
#include "Disk.hpp"
#include "SpherePartConvex.hpp"
#include "SpherePartConcave.hpp"
#include "TorusPartConvex.hpp"
...
// round rim - need an instance for this as it's a half torus
	...
	objects.push_back(new Disk(Point3D(0, h, 0), Normal(0, 1, 0),xc));				// the disk just touches the bottom of the meniscus
